...
describeForSsp('Product Class Functionality', { tags: ['@backoffice', '@productManagement', '@ssp', 'product','shipment-service-points', 'self-service-portal', 'spryker-core-back-office', 'spryker-core'] }, () => {

...
describe(
  ...
  (): void => {
    ...
    it('initializes a live DataTable whose data endpoint returns HTTP 200 JSON with the recordsTotal/recordsFiltered/data shape', (): void => {
    ...
    it('loads the stats aggregation partial over AJAX with HTTP 200', (): void => {
    ...
    it('marks Configuration, Status and Created At sortable and the remaining columns non-sortable', (): void => {
      auditLogsPage.visitAndAwaitTableData();

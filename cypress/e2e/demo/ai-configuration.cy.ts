...
describe(
  ...
  (): void => {
    ...
    it('masked OpenAI API token field accepts typed input and stays type=password without being saved', (): void => {
    ...
    it('selecting the AWS Bedrock provider radio hides the OpenAI model field and reveals the AWS Bedrock model field', (): void => {
      aiConfigurationPage.visitTab('ai_commerce', 'backoffice_assistant');
    ...
    it('changing the OpenAI model value shows the unsaved-changes bar, and Save persists the value across a reload', (): void => {

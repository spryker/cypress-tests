...
describe(
  ...
  (): void => {
    ...
    it(
      'product edit page opens (HTTP 200) with the Smart PIM JS bundles and AI-assist controls rendered',
      { tags: ['@demo-smoke'] },
      (): void => {
        smartPimPage
    ...
    it(
      'makes no AI provider request on load — the controls render but are never triggered',
      { tags: ['@demo-smoke'] },
      (): void => {
    ...
    it(
      'clicking the request-builder trigger opens the all-actions popover with translate and improve-content choices and fires no provider request',
      { tags: ['@demo-smoke'] },
      (): void => {
    ...
    it(
      'selecting "translate to" inside the all-actions popover opens the locale-selector popover with locale buttons and fires no translate request',
      { tags: ['@demo-smoke'] },
      (): void => {
    ...
    it(
      'clicking the category trigger with an empty name/description payload opens the category modal in its empty state and fires no provider request',
      { tags: ['@demo-smoke'] },
      (): void => {
    ...
    it(
      'clicking an alt-text trigger with an empty image-url payload opens the alt-text modal in its empty state and fires no provider request',
      { tags: ['@demo-smoke'] },
      (): void => {
    ...
    it(
      'clicking the category trigger on a populated product issues the category-suggestion POST and recovers gracefully when the provider fails',
      { tags: ['@demo-smoke'] },
      (): void => {
    ...
    it(
      'clicking an alt-text trigger on a populated image issues the image-alt-text POST and recovers gracefully when the provider fails',
      { tags: ['@demo-smoke'] },
      (): void => {

...
(['b2c', 'b2b', 'b2c-mp'].includes(Cypress.env('repositoryId')) ? describe.skip : describe)(
  'request management',
  { tags: ['@mp', '@merchant-b2b-contract-requests', 'marketplace-merchant-contract-requests', 'merchant-contract-requests', 'merchant-contracts', 'company-account', 'marketplace-merchantportal-core', 'spryker-core'] },
  (): void => {

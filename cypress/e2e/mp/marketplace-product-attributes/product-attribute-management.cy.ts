...
(['b2b', 'b2c'].includes(Cypress.env('repositoryId')) ? describe.skip : describe)(
  ...
  { tags: ['@merchant-product-attributes', 'product','marketplace-merchantportal-core', 'marketplace-product', 'marketplace-merchant-portal-product-management', 'spryker-core'] },
  (): void => {

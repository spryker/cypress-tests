...
(['b2c', 'b2b'].includes(Cypress.env('repositoryId')) ? describe.skip : describe)(
  ...
  { tags: ['@mp', '@marketplace-agent-assist', 'marketplace-agent-assist','marketplace-order-management', 'order-management', 'state-machine', 'product', 'marketplace-product', 'marketplace-merchant-portal-product-management', 'marketplace-product-offer', 'product-offer-shipment', 'marketplace-merchantportal-core', 'spryker-core'] },
  (): void => {

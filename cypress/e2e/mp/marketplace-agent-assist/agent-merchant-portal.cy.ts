...
(['b2c', 'b2b'].includes(Cypress.env('repositoryId')) ? describe.skip : describe)(
  ...
  { tags: ['@mp', '@marketplace-agent-assist', 'marketplace-agent-assist','marketplace-order-management', 'product', 'marketplace-product-offer', 'marketplace-merchantportal-core', 'spryker-core'] },
  (): void => {

...
describe('publish and synchronize', { tags: ['@yves', '@product', 'product', 'marketplace-product', 'spryker-core-back-office', 'spryker-core', 'inventory-management', 'search', 'catalog', 'prices', 'cart'] }, (): void => {

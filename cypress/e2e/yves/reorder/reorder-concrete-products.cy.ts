...
describe('reorder concrete products', { tags: ['@yves', '@reorder', 'product', 'marketplace-product', 'spryker-core', 'reorder', 'cart', 'non-splittable-products', 'product-options', 'marketplace-product-options'] }, (): void => {

 ...
 */
describe('order amendment cancel', { tags: ['@yves', '@order-amendment', 'product', 'marketplace-product', 'marketplace-merchant-portal-product-management', 'order-management', 'marketplace-order-management', 'state-machine',  'order-amendment', 'non-splittable-products', 'cart', 'checkout', 'spryker-core'] }, (): void => {

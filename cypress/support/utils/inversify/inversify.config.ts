...
import {
  SuiteCompanyRoleIndexRepository
} from '../../pages/yves/company/company-role/index/repositories/suite-company-role-index-repository';
import {
  CompanyRoleCreateRepository
} from '../../pages/yves/company/company-role/create/company-role-create-repository';
import {
  SuiteCompanyRoleCreateRepository
} from '../../pages/yves/company/company-role/create/repositories/suite-company-role-create-repository';

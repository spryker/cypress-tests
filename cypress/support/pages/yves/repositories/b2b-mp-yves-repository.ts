...
@injectable()
export class B2bMpYvesRepository implements YvesRepository {
  selectLocale = (localeName: string): Cypress.Chainable =>
    cy.get('[data-qa="component header"] [data-qa="language-selector"]').select(localeName.toUpperCase(), { force: true });

...
export class B2bProductRepository implements ProductRepository {
  ...
  getSoldByProductOfferRadios = (): Cypress.Chainable =>
    cy.get('[data-qa="component merchant-product-offer-item"] input[type="radio"], [data-qa="component seller-list-item"] input[type="radio"][name="product_offer_reference"]');

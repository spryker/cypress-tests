...
import {CheckoutAddress} from "../../../../types/common/address";
...
export class YvesCheckoutAddressPage extends AbstractPage {
  ...
  constructor(@inject(TYPES.YvesCheckoutAddressRepository) private repository: YvesCheckoutAddressRepository) {
    super();
  }

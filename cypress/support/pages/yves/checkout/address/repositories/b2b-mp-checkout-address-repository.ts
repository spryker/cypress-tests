...
export class B2bMpCheckoutAddressRepository implements CheckoutAddressRepository {
  ...
  getShippingAddressFirstNameField = (): Cypress.Chainable =>
    cy.get('#addressesForm_multiShippingAddresses_0_shippingAddress_first_name');
  getShippingAddressLastNameField = (): Cypress.Chainable =>
    cy.get('#addressesForm_multiShippingAddresses_0_shippingAddress_last_name');
  getShippingAddressAddress1Field = (): Cypress.Chainable =>
    cy.get('#addressesForm_multiShippingAddresses_0_shippingAddress_address1');
  getShippingAddressAddress2Field = (): Cypress.Chainable =>
    cy.get('#addressesForm_multiShippingAddresses_0_shippingAddress_address2');
  getShippingAddressZipCodeField = (): Cypress.Chainable =>
    cy.get('#addressesForm_multiShippingAddresses_0_shippingAddress_zip_code');
  getShippingAddressCityField = (): Cypress.Chainable =>
    cy.get('#addressesForm_multiShippingAddresses_0_shippingAddress_city');
  getShippingAddressCompanyField = (): Cypress.Chainable =>
    cy.get('#addressesForm_multiShippingAddresses_0_shippingAddress_company');
  getShippingAddressPhoneField = (): Cypress.Chainable =>
    cy.get('#addressesForm_multiShippingAddresses_0_shippingAddress_phone');

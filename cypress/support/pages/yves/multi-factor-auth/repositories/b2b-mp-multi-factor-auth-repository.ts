...
@injectable()
export class B2bMpMultiFactorAuthRepository implements MultiFactorAuthRepository {
  ...
  getVerifyButton(): Cypress.Chainable {
    return cy.get('form[name="codeValidationForm"] button');
  }

  getVerificationPopup(): Cypress.Chainable {
    return cy.get('div[data-qa*="multi-factor-authentication-content"]', { timeout: 10000 });
  }

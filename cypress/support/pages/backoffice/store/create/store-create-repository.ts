...
export class StoreCreateRepository {
  ...
  getStoreContextTabButton = (): Cypress.Chainable => cy.get('[data-tab-content-id="tab-content-store_context"]', { timeout: 15000 });
  getAddStoreContextButton = (): Cypress.Chainable => cy.get('#tab-content-store_context .btn.add-store-context', { timeout: 15000 });
  getTimezoneSelector = (): Cypress.Chainable => cy.get('#store_applicationContextCollection_applicationContexts_1_timezone', { timeout: 25000 });
}

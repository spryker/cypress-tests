...
export class ProductAbstractTypeRepository {
  ...
  getProductAbstractTypeOptionSelector = (value: string): string =>
    `[data-qa="product-abstract-types"] option[value="${value}"]`;
  ...
  getSelectedTypeVerificationSelector = (): string =>
    `${this.getProductAbstractTypeSelectSelector()} ~ ${this.getSiblingSelector()} ${this.getSelect2Selector()} ${this.getSelect2ChoiceItemSelector()}`;
}

...
export class PlaceGuestMpOrderScenario {
  constructor(
    ...
    @inject(YvesCheckoutCustomerPage) private checkoutCustomerPage: YvesCheckoutCustomerPage,
  ...
  public execute = (productSkus: string[]): CustomerGuest => {
    ...
    const customerGuest: CustomerGuest = this.checkoutCustomerPage.checkoutAsGuest();
